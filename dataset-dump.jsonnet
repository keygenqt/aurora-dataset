{
  dataset: {
    faq: {
      ...
      ru: [
        {
          t: 'Демонстрационное_сообщение_с_набором_доступных_элементов.',
          b: |||
        ...
        {
          t: 'Что такое PSDK?',
          b: 'Aurora PSDK — это набор инструментов для разработки, отладки и тестирования компонентов ОС Аврора.',
          a: {
            fname: 'Виталий',
            lname: 'Зарубин',
          },
        ...
        {
          t: 'Где приобрести устройств ОС Аврора?',
          b: |||
        ...
        {
          t: 'Какой статус поддержки Fluter для ОС Аврора?',
          b: |||
        ...
        {
          t: 'Где указывать разрешения (permissions) в ОС Аврора?',
          b: |||
